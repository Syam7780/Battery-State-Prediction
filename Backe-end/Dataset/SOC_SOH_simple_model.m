...
% J. A. Braun, R. Behmann, D. Schmider, W. G. Bessler, 
% "State of charge and state of health diagnosis of batteries with 
% voltage-controlled models", Journal of Power Sources 544 (2022), 231828.
% DOI: https://doi.org/10.1016/j.jpowsour.2022.231828
% Please cite this paper if you use this code or algorithm.

% This script performs SOC and SOH diagnosis using the "simple" equivalent 
% circuit model

% Copyright (c) 2022 Wolfgang G. Bessler and Jonas A. Braun
 
% This code is provided under the CC-BY-NC-4.0 license: Creative Commons
% Attribution Non Commercial 4.0 International. The detailed information to
% this license can be found on the following website:
% https://creativecommons.org/licenses/by-nc/4.0/legalcode.
 
% Intellectual property information: Please note that the algorithms
% are subject to industrial property rights, including, but not
% necessarily limited to, German patent DE102019127828B4 and international 
% patent application WO2021073690A2. Any use of the codes and algorithms 
% presented here is subject to these property rights.
